...
from services.postprocessor.postprocessor import PostProcessor
from services.utils.text import TextNormalizer
from services.utils.paragraph_handler import ParagraphHandler
...
class TextToSpeechEngine:
    ...
    def infer_from_text(
        ...
        for paragraph in paragraphs:
            paragraph = self.handle_transliteration(
                paragraph, primary_lang, transliterate_roman_to_native
            )
            paras = []
